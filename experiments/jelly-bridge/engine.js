...
class Game {
 ...
 reset(slow=false){this.slow=slow;this.time=0;this.count=0;this.perfect=0;this.current={x:10,w:120};this.next={x:230,w:90};this.camera=0;this.length=0;this.angle=0;this.playerX=108;this.playerY=480;this.phase=0;this.state='waiting';this.events=[];this.bridges=[];this.particles=[];this.result='';}
...
c.fillStyle='#4c3b60';c.textAlign='left';c.font='bold 44px sans-serif';c.fillText(String(g.count).padStart(2,'0'),30,78);c.font='16px sans-serif';c.fillText('/ 6',95,74);c.textAlign='right';c.fillStyle='#517d6c';c.font='bold 13px sans-serif';c.fillText(g.slow?'SLOW':'CLASSIC',448,69);
